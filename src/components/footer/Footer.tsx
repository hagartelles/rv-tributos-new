                ...
                <div className="flex justify-center gap-4 mb-8">
                    {socialLinks.map((social) => (
                        <Link
                            ...
                            className="w-12 h-12 rounded-full bg-rv-green flex items-center justify-center text-rv-yellow transition-all duration-300 hover:scale-110 hover:bg-rv-greenMusgo active:scale-95"
